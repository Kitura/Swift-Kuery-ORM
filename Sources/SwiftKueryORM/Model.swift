...
public extension Model {
    ...
    private static func executeTask(using db: Database? = defaultDatabase, task: @escaping ((Connection?, QueryError?) -> ())) {
    ...
    @discardableResult
    static func createTableSync(using db: Database? = defaultDatabase) throws -> Bool {
        var result: Bool?
    ...
    static func createTable(using db: Database? = defaultDatabase, _ onCompletion: @escaping (Bool?, RequestError?) -> Void) {
        var table: Table
        do {
    ...
    @discardableResult
    static func dropTableSync(using db: Database? = defaultDatabase) throws -> Bool {
        var result: Bool?
        var error: RequestError?
        let semaphore = DispatchSemaphore(value: 0)
    ...
    static func dropTable(using db : Database? = defaultDatabase, _ onCompletion: @escaping (Bool?, RequestError?) -> Void) {
        var table: Table
        do {
            table = try Self.getTable()
        } catch let error {
    ...
    func save(using db: Database? = defaultDatabase, _ onCompletion: @escaping (Self?, RequestError?) -> Void) {
        var table: Table
    ...
    func save<I: Identifier>(using db: Database? = defaultDatabase, _ onCompletion: @escaping (I?, Self?, RequestError?) -> Void) {
        var table: Table
        var values: [String : Any]
        do {
            table = try Self.getTable()
    ...
    func update<I: Identifier>(id: I, using db: Database? = defaultDatabase, _ onCompletion: @escaping (Self?, RequestError?) -> Void) {
        var table: Table
        var values: [String: Any]
        do {
            table = try Self.getTable()
    ...
    static func delete(id: Identifier, using db: Database? = defaultDatabase, _ onCompletion: @escaping (RequestError?) -> Void) {
        var table: Table
        do {
            table = try Self.getTable()
        } catch let error {
    ...
    static func deleteAll(using db: Database? = defaultDatabase, _ onCompletion: @escaping (RequestError?) -> Void) {
        var table: Table
        do {
            table = try Self.getTable()
        } catch let error {
    ...
    static func deleteAll<Q: QueryParams>(using db: Database? = defaultDatabase, matching queryParams: Q?, _ onCompletion: @escaping (RequestError?) -> Void) {
        var table: Table
        do {
            table = try Self.getTable()
        } catch let error {
    ...
    private func executeQuery(query: Query, parameters: [Any?], using db: Database? = defaultDatabase, _ onCompletion: @escaping (Self?, RequestError?) -> Void ) {
    ...
    private func executeQuery<I: Identifier>(query: Query, parameters: [Any?], using db: Database? = defaultDatabase, _ onCompletion: @escaping (I?, Self?, RequestError?) -> Void ) {
        Self.executeTask(using: db) { connection, error in
            guard let connection = connection else {
                guard let error = error else {
    ...
    static func executeQuery(query: Query, parameters: [Any?], using db: Database? = defaultDatabase, _ onCompletion: @escaping (Self?, RequestError?) -> Void ) {
        Self.executeTask(using: db) { connection, error in
            guard let connection = connection else {
                guard let error = error else {
                    return onCompletion(nil, RequestError(.ormInternalError, reason: "Unknow error when getting connection"))
    ...
    static func executeQuery<I: Identifier>(query: Query, parameters: [Any?], using db: Database? = defaultDatabase, _ onCompletion: @escaping (I?, Self?, RequestError?) -> Void ) {
        Self.executeTask(using: db) { connection, error in
            guard let connection = connection else {
                guard let error = error else {
                    return onCompletion(nil, nil, RequestError(.ormInternalError, reason: "Unknow error when getting connection"))
    ...
    /// - Parameter using: Optional Database to use
    /// - Parameter onCompletion: The function to be called when the execution of the query has completed. The function will be passed a tuple of ([Self]?, RequestError?), of which one will be nil, depending on whether the query was successful.
    static func executeQuery(query: Query, parameters: [Any?]? = nil, using db: Database? = defaultDatabase, _ onCompletion: @escaping ([Self]?, RequestError?)-> Void ) {
        Self.executeTask(using: db) { connection, error in
            guard let connection = connection else {
                guard let error = error else {
                    return onCompletion(nil, RequestError(.ormInternalError, reason: "Unknow error when getting connection"))
    ...
    static func executeQuery<I: Identifier>(query: Query, parameters: [Any?]? = nil, using db: Database? = defaultDatabase, _ onCompletion: @escaping ([(I, Self)]?, RequestError?) -> Void ) {
        Self.executeTask(using: db) { connection, error in
            guard let connection = connection else {
                guard let error = error else {
                    return onCompletion(nil, RequestError(.ormInternalError, reason: "Unknow error when getting connection"))
    ...
    static func executeQuery(query: Query, parameters: [Any?]? = nil, using db: Database? = defaultDatabase, _ onCompletion: @escaping (RequestError?) -> Void ) {
        Self.executeTask(using: db) { connection, error in
            guard let connection = connection else {
                guard let error = error else {
    ...
    static func find<I: Identifier>(id: I, using db: Database? = defaultDatabase, _ onCompletion: @escaping (Self?, RequestError?) -> Void) {
        var table: Table
        do {
            table = try Self.getTable()
        } catch let error {
    ...
    ///
    static func findAll(using db: Database? = defaultDatabase, _ onCompletion: @escaping ([Self]?, RequestError?) -> Void) {
        var table: Table
        do {
            table = try Self.getTable()
        } catch let error {
    ...
    static func findAll<I: Identifier>(using db: Database? = defaultDatabase, _ onCompletion: @escaping ([(I, Self)]?, RequestError?) -> Void) {
        var table: Table
        do {
            table = try Self.getTable()
        } catch let error {
    ...
    static func findAll<Q: QueryParams>(using db: Database? = defaultDatabase, matching queryParams: Q? = nil, _ onCompletion: @escaping ([Self]?, RequestError?) -> Void) {
        var table: Table
        do {
            table = try Self.getTable()
        } catch let error {
    ...
    /// - Parameter using: Optional Database to use
    /// - Returns: An array of tuples (id, model)
    static func findAll<Q: QueryParams, I: Identifier>(using db: Database? = defaultDatabase, matching queryParams: Q? = nil, _ onCompletion: @escaping ([(I, Self)]?, RequestError?) -> Void) {
        var table: Table
        do {
            table = try Self.getTable()
        } catch let error {
